...
void TestMath(std::string name)
{
	...
	std::fill(y.begin(), y.end(), 0);
	M<T>::vAdd_mtv(A.data(), 10, 10, 10, x.data(), 1, y.data(), 1);
	for(size_t i = 0; i < 10; ++i)
	{
		T value = 0.0;
		for(size_t j = 0; j < 10; ++j)
	...
	M<T>::mAdd_m(A.data(), 10, 10, 10, B.data(), 10);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
			NNHardAssert(almostEqual<T>(B[i * 10 + j], A[i * 10 + j] + 10), name + "::mAdd_m failed!");
	
	std::fill(B.begin(), B.end(), 10);
	M<T>::mAdd_mt(A.data(), 10, 10, 10, B.data(), 10);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
	...
	M<T>::mAdd_mm(10, 10, 10, A.data(), 10, B.data(), 10, D.data(), 10, 1, 0);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
	...
	M<T>::mAdd_mtm(10, 10, 10, A.data(), 10, B.data(), 10, D.data(), 10, 1, 0);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
			NNHardAssert(almostEqual<T>(C[i * 10 + j], D[i * 10 + j]), name + "::mAdd_mm failed!");
	
	addMatrixMultiply<false, true, T>(10, 10, 10, A.data(), 10, B.data(), 10, C.data(), 10, 1, 0);
	M<T>::mAdd_mmt(10, 10, 10, A.data(), 10, B.data(), 10, D.data(), 10, 1, 0);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
			NNHardAssert(almostEqual<T>(C[i * 10 + j], D[i * 10 + j]), name + "::mAdd_mm failed!");
	
	addMatrixMultiply<true, true, T>(10, 10, 10, A.data(), 10, B.data(), 10, C.data(), 10, 1, 0);
	M<T>::mAdd_mm(10, 10, 10, B.data(), 10, A.data(), 10, D.data(), 10, 1, 0);
	for(size_t i = 0; i < 10; ++i)
		for(size_t j = 0; j < 10; ++j)
