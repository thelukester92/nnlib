...
public:
	Nadam(Module &model, Critic &critic) :
	...
	Nadam &learningRate(real_t learningRate)
	{
	...
	virtual Nadam &step(const Tensor &input, const Tensor &target) override
	{
